...
helm.sh/chart: {{ include "grafana-reporter.chart" . }}
...
*/}}
{{- define "grafana-reporter.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "grafana-reporter.fullname" .) .Values.serviceAccount.name }}
{{- else }}
